...
pub trait Exportable {
    ...
    /// knows which format the user chose -- one picked from [`Self::known_export_formats`], say
    /// -- should use this rather than encoding the choice into a filename and having it inferred
    /// straight back out.
    ///
    /// # Errors
