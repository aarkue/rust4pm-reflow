...
pub enum SinkError {
    ...
    /// *different* object type -- two distinct entities collided on one id, rather than the plain
...
pub trait ExtractionSink: Debug {
    ...
    /// Append one more timed value to an already-added object's named attribute -- how a
    ...
    /// and, under [`MissingEndpointPolicy::Create`](super::blueprint::MissingEndpointPolicy::Create),
