...
/// came from -- `mappings[1]` for a top-level `Single`, `mappings[0].mappings[2]` for the third
/// member of the first `Ordered` group -- so a diagnostic can point back at what the author
/// wrote instead of a position in the desugared, flattened list.
