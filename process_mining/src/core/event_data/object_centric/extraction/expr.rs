...
///
/// Scanning the output instead -- which is what the original implementation did -- misreads a
/// substituted value that itself contains braces, and accepts an unterminated placeholder.
